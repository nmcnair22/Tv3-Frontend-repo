...
import NewTab1 from '../pages/CustomerFinancialProfile.vue';
    ...
    meta: {
      ...
      headerOptions: {
        ...
        tabs: [
          ...
          { label: 'Customer Financial Profile', icon: 'pi pi-fw pi-chart-line', route: '/finance/dashboard-local/new-tab-1' },
